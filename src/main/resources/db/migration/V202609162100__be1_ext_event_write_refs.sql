-- =====================================================================================
-- 🔴 버전 주의 — 이 파일은 원래 V202608290200 이었다(2026-08-29 작성). 그 사이 main 에
--    V202609072000(#74)·V202609161900(#76)이 적용돼, 낮은 번호로 두면 Flyway 가
--    "Detected resolved migration not applied to database" 로 **검증에 실패한다**
--    (out-of-order 설정이 없어 기본값 false). 실패하면 entityManagerFactory 가 못 떠
--    앱이 기동하지 못한다. 어떤 DB 에도 적용된 적이 없어 번호만 올렸다 — 체크섬 문제 없음.
--
