 ...
 * 앱 멤버만 호출할 수 있으며, 네이버는 <b>조회 API 자체가 없다</b>(공식 문서에 {@code createSchedule} 하나뿐).
...
public interface CalendarProvider {
    ...
    /** 사용자의 캘린더 목록 (ONB-08). */
    List<ProviderCalendar> listCalendars(String accessToken);
     ...
     * @param to   조회 종료(제외)
     */
    List<ProviderEvent> listEvents(String accessToken, String externalCalendarId, String calendarName,
